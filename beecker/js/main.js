...
function wyswietl() {
    ...
    if (przechowaj >= 1e3 && przechowaj < 1e6) {
        currentvalue.textContent = (przechowaj / 1e3).toFixed(2) + " Thousand";
    } else if (przechowaj >= 1e6 && przechowaj < 1e9) {
        currentvalue.textContent = (przechowaj / 1e6).toFixed(2) + " Milion";
    } else if (przechowaj >= 1e9 && przechowaj < 1e12) {
        currentvalue.textContent = (przechowaj / 1e9).toFixed(2) + " Bilion";
    } else if (przechowaj >= 1e12 && przechowaj < 1e15) {
        currentvalue.textContent = (przechowaj / 1e12).toFixed(2) + " Trilion";
    } else if (przechowaj >= 1e15 && przechowaj < 1e18) {
        currentvalue.textContent = (przechowaj / 1e15).toFixed(2) + " Quadrilion";
    } else if (przechowaj >= 1e18 && przechowaj < 1e21) {
        currentvalue.textContent = (przechowaj / 1e18).toFixed(2) + " Pentilion";
    } else if (przechowaj >= 1e21 && przechowaj < 1e24) {
        currentvalue.textContent = (przechowaj / 1e21).toFixed(2) + " Sextilion";
    } else if (przechowaj >= 1e24 && przechowaj < 1e27) {
        currentvalue.textContent = (przechowaj / 1e24).toFixed(2) + " Septilion";
    } else if (przechowaj >= 1e27 && przechowaj < 1e30) {
        currentvalue.textContent = (przechowaj / 1e27).toFixed(2) + " Octilion";
    } else if (przechowaj >= 1e30 && przechowaj < 1e33) {
        currentvalue.textContent = (przechowaj / 1e30).toFixed(2) + " Nonilion";
    } else if (przechowaj >= 1e33) {
        currentvalue.textContent = (przechowaj / 1e33).toFixed(2) + " Decilion";
    } else {
        currentvalue.textContent = przechowaj;
    }
    Bps();
...
for (let i = 0; i < pszczoly.length; i++) {
    ...
    divs[i].querySelector('button').addEventListener('click', () => {
        if (money >= pszczola.cena) {
            ...
            currentvalue.textContent = "Ilość pszczół:" + pszczola.ile + " Cena pszczoły:" + pszczola.cena;
        }
    })
